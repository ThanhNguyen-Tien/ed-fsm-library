...
namespace core
{
	...
	public:
		...
		SmallFixedEvent(Component *component, Handler handler) : Base(component, handler) {}
	...
	public:
		...
		BigFixedEvent(Component *component, Handler handler) : Base(component, handler), pool_(buffer_, N) {}
